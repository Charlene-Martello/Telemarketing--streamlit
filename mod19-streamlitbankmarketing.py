...
def main():
    ...
    if data_file_1 is not None:
        ...
        # Exibe a mensagem solicitada enquanto o arquivo não é carregado
        st.write("Por favor, para ter acesso às funcionalidades dessa página, carregue o arquivo.")

    # Executa o código abaixo apenas se o arquivo foi carregado
    if bank_raw is not None:
